          ...
          <TabsContent value="search" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Use natural language to discover cryoprotectants. Ask questions like "Find molecules similar to DMSO
                  but less toxic"
                </CardDescription>
              </CardHeader>
                ...
                <div className="h-96 flex items-center justify-center border-2 border-dashed border-gray-300 rounded-lg">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-4">
                      Explore 9,494 molecules across efficacy, toxicity, and permeability dimensions
                    </p>
                    <Button>
